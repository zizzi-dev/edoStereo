...
module.exports = (() => {
    const config = { "main": "index.js", "info": { "name": "edoStereo", "authors": [{ "name": "edo#0001", "discord_id": "269831113919299584" }], "version": "0.0.3", "description": "[ENG] Adds stereo sound to discord. Better Discord v1.8.4" }, "changelog": [{ "title": "changes", "items": ["BetterDiscord Stereo Sound for 1.8.4"] }], "defaultConfig": [{ "type": "switch", "id": "enableToasts", "name": "Enable Notificaton", "note": "Warning for language setting features", "value": true }] };
    ...
    return !global.ZeresPluginLibrary ? class {
        ...
        load() {
            BdApi.showConfirmationModal("Missing BetterDiscord Library", `ZeresPluginLibrary is missing. Click Install Now to download it.`, {
                ...
                settingsWarning() {
                    ...
                    if (
                        ...
                        if (this.settings.enableToasts) {
                            Toasts.show(
                                "Turn off background noise features of Discord. -> Language settings.",
